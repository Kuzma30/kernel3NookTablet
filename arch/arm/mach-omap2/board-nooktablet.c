...
<<<<<<< HEAD
		ARRAY_SIZE(blaze_uart1_pads), &blaze_uart_info);
=======
		ARRAY_SIZE(blaze_uart1_pads), &blaze_uart_info_uncon);
>>>>>>> 3b4ecbc7100ddc05e18a37500a7b4baeeba3851b
...
void update_pad_config(void);
void update_pad_config(void) //make pad mux simullar to 2.6 kernel
{
	omap_mux_init_signal("usbb1_hsic_data.usbb1_hsic_data", \
		OMAP_PIN_OUTPUT | \
		OMAP_PIN_OFF_OUTPUT_LOW | \
		OMAP_MUX_MODE0);
	
	
	omap_mux_init_signal("usbb1_hsic_strobe.usbb1_hsic_strobe", \
		OMAP_PIN_OUTPUT | \
		OMAP_PIN_OFF_OUTPUT_LOW | \
		OMAP_MUX_MODE0);
	

	omap_mux_init_signal("usbb1_ulpitll_dat0.usbb1_ulpitll_dat0", \
		OMAP_PIN_INPUT_PULLDOWN | \
		OMAP_PIN_OFF_OUTPUT_LOW |\
		OMAP_MUX_MODE4);

	omap_mux_init_signal("usbb1_ulpitll_dat1.usbb1_ulpitll_dat1", \
		OMAP_PIN_INPUT_PULLDOWN | \
		OMAP_PIN_OFF_OUTPUT_LOW |\
		OMAP_MUX_MODE4);
	
	omap_mux_init_signal("usbb1_ulpitll_dat2.usbb1_ulpitll_dat2", \
		OMAP_PIN_INPUT_PULLDOWN | \
		OMAP_PIN_OFF_OUTPUT_LOW |\
		OMAP_MUX_MODE4);
	
	omap_mux_init_signal("usbb1_ulpitll_dat3.usbb1_ulpitll_dat3", \
		OMAP_PIN_INPUT_PULLDOWN | \
		OMAP_PIN_OFF_OUTPUT_LOW |\
		OMAP_MUX_MODE4);
	
	omap_mux_init_signal("usbb1_ulpitll_dat4.usbb1_ulpitll_dat4", \
		OMAP_PIN_INPUT_PULLDOWN | \
		OMAP_PIN_OFF_OUTPUT_LOW |\
		OMAP_MUX_MODE4);
	
	omap_mux_init_signal("usbb1_ulpitll_dat5.usbb1_ulpitll_dat5", \
		OMAP_PIN_INPUT_PULLDOWN | \
		OMAP_PIN_OFF_OUTPUT_LOW |\
		OMAP_MUX_MODE4);
	
	omap_mux_init_signal("usbb1_ulpitll_dat6.usbb1_ulpitll_dat6", \
		OMAP_PIN_INPUT_PULLDOWN | \
		OMAP_PIN_OFF_OUTPUT_LOW |\
		OMAP_MUX_MODE4);
	
	omap_mux_init_signal("usbb1_ulpitll_dat7.usbb1_ulpitll_dat7", \
		OMAP_PIN_INPUT_PULLDOWN | \
		OMAP_PIN_OFF_OUTPUT_LOW |\
		OMAP_MUX_MODE4);

	omap_mux_init_signal("usbb1_ulpitll_dir.usbb1_ulpitll_dir", \
		OMAP_PIN_INPUT_PULLDOWN | \
		OMAP_PIN_OFF_OUTPUT_LOW |\
		OMAP_MUX_MODE4);

	
	omap_mux_init_signal("usbb1_ulpitll_nxt.usbb1_ulpitll_nxt", \
		OMAP_PIN_INPUT_PULLDOWN | \
		OMAP_PIN_OFF_OUTPUT_LOW |\
		OMAP_MUX_MODE4);

	omap_mux_init_signal("usbb1_ulpitll_stp.usbb1_ulpitll_stp", \
		OMAP_PIN_OUTPUT | \
		OMAP_MUX_MODE4);
	...
	omap_mux_init_signal("gpmc_ad13.gpio_37", \
						...
						OMAP_MUX_MODE3);
	/*gpio_32*/
	omap_mux_init_signal("gpmc_ad8.gpio_32", \
						OMAP_PIN_INPUT | \
						OMAP_PIN_OFF_OUTPUT_LOW |\
	...
	omap_mux_init_signal("sdmmc1_clk.sdmmc1_clk", \
						...
						OMAP_MUX_MODE0);
	/*uart1_rx*/
	omap_mux_init_signal("mcspi1_cs.uart1_rx", \
						OMAP_PIN_INPUT_PULLUP | \
						OMAP_PIN_OFF_WAKEUPENABLE | \
						OMAP_MUX_MODE1);
	...
	/*gpio_wk29*/
	omap_mux_init_signal("sys_pwron_reset_out.gpio_wk29", \
						OMAP_PIN_OUTPUT | \
						OMAP_PIN_OFF_WAKEUPENABLE |\
						OMAP_MUX_MODE3);
	/*sys_nirq1*/
	omap_mux_init_signal("sys_nirq1.sys_nirq1", \
						OMAP_PIN_INPUT_PULLUP | \
						OMAP_PIN_OFF_WAKEUPENABLE | \
						OMAP_MUX_MODE0);

	/*gpio_143*/
	omap_mux_init_signal("uart3_rx_irrx.gpio_143", \
						OMAP_PIN_OUTPUT | \
						OMAP_PIN_OFF_WAKEUPENABLE | \
						OMAP_MUX_MODE3);
}
